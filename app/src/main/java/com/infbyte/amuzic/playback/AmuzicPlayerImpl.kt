...
class AmuzicPlayerImpl
    @Inject
    constructor() : AmuzicPlayer {
        ...
        private val mediaControllerFutureListener: Runnable =
            Runnable {
                try {
        ...
        private fun startTimer() {
            stopTimer()
            timer =
                timer(startAt = Calendar.getInstance().time, period = 10L) {
                    runBlocking {
